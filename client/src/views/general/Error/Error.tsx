    ...
    >
      ...
      >
        {(() => {
          switch (status) {
            case 404:
              return strings.common.pageNotFoundTitle;
            default:
              return strings.common.unexpectedErrorTitle;
          }
        })()}
      </Typography>
      <Typography variant="h6">
        {(() => {
          switch (status) {
            case 404:
              return strings.common.pageNotFoundMessage;
            default:
              return strings.common.unexpectedErrorMessage;
          }
        })()}
      </Typography>
      <Box
      ...
      <Button
        type="button"
        content={strings.actions.takeMeBack}
        customStyle={{
          borderRadius: 1,
          width: 'fit-content',
          margin: '1.5rem 0 0',
