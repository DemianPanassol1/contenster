    ...
    <Box sx={{ margin: '0.25rem 0 0' }}>
      ...
      >
        ...
        {(session?.establishmentCount ?? 0) > 1 && (
          ...
          >
            ...
            <Typography variant="body2">
              {strings.actions.changeEstablishment}
            </Typography>
          </MenuItem>
        )}
        <MenuItem
        ...
        >
          ...
          <Typography variant="body2">
            {strings.actions.changePassword}
          </Typography>
        </MenuItem>
        <MenuItem
          to="/profile"
        ...
        >
          ...
          <Typography variant="body2">{strings.common.profile}</Typography>
        </MenuItem>
        <Divider />
        <MenuItem
          disabled={loading}
        ...
        >
          ...
          <Typography variant="body2">{strings.actions.logout}</Typography>
        </MenuItem>
      </MenuComponent>
    </Box>
  );
